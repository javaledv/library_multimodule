package ml.ledv.library.controller.rest;

import ml.ledv.library.controller.rest.params.BookParam;
import ml.ledv.library.controller.rest.params.UserParams;
import ml.ledv.library.controller.rest.responce.ErrorResponse;
...
@Controller
@RequestMapping(Routing.API_PATH + Routing.BOOKS_PATH)
